...
@app.get("/query", 
          ...
          description="Sample Payload : http://localhost:8181/cluster/health?es_url=http://localhost:9200", 
          summary="DB Query")
...
@app.post("/get_db_query", status_code=StatusHanlder.HTTP_STATUS_200,
          responses={
            200: {"description" : "OK"},
            404 :{"description" : "URl not found"}
          },
          description="db_query_execute", summary="db_query_execute")
